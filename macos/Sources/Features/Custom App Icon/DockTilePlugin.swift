...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "info.olaugh.aghoul.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "info.olaugh.aghoul")
    #endif
